...
pto.mte_ub_gm %ub_partial_0, %gm_result, %c0_i64, ...
...
pto.mte_ub_gm %ub_partial_1, %gm_result, %c0_i64, ...
```
...
pto.mte_ub_gm %ub_out, %gm_out, %c0_i64, ...
```
...
scf.for %i = %c0 to %N step %c1 {
  ...
  pto.mte_ub_gm %ub_out[%pp], %gm_out[%i], %c0_i64, ...
