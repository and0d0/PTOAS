...
def main() -> None:
    ...
    expect(
        re.search(r"pto\.mte_ub_gm [^\n]+, %c0[^,\n]*, [^,\n]+ nburst", public_surface_text) is not None,
        "mte_store(...) should pass default l2_cache_ctl as the third pto.mte_ub_gm operand",
    )
    ...
    expect(
        re.search(r"pto\.mte_ub_gm [^\n]+, %c7[^,\n]*, [^,\n]+ nburst", data_movement_surface_text) is not None,
        "mte_ub_gm(..., l2_cache_ctl=7) should pass cache ctl as the third operand",
    )
